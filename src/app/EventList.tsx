	...
	return (
		<div className="card bg-base-100 card-lg shadow-sm">
			<div className="card-body">
				...
				<div className="card card-lg border rounded-4xl border-neutral-300 w-96 mt-2" >
					<div className='relative'>
						<div className="absolute top-3 left-3 z-100">
							<button className='btn btn-soft btn-sm rounded-tl-3xl text-neutral-800' onClick={() => setOpenSiteModal(true)}>
						...
						<div className="dropdown dropdown-center absolute top-3 right-3 z-100">
							<button tabIndex={0} className='btn btn-soft btn-sm rounded-tr-3xl text-neutral-800'>
								<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
				...
				<dialog className="modal" open={openSiteModal}>
					<div className="modal-box lg:w-96 xl:w-96 p-0">
						<div className="flex flex-col items-center pb-10 pt-12">
							...
							<div className="inline-flex gap-1 mt-5" role="group">
								<button className="btn btn-soft delay-150 transition shadow-xl hover:-rotate-5 hover:-translate-y-1 hover:scale-105 ease-in-out">
									<svg className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
								...
								<button className="btn btn-soft delay-150 transition shadow-xl hover:-rotate-2 hover:-translate-y-1 hover:scale-105 ease-in-out">
									<svg className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
										<path fill="currentColor" fill-rule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clip-rule="evenodd" />
									</svg>

								</button>
								<button className="btn btn-soft delay-150 transition shadow-xl hover:rotate-2 hover:-translate-y-1 hover:scale-105 ease-in-out"><svg className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
